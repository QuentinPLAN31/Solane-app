...
{
  "observed": ["<one short, concrete, plain-language sentence describing something genuinely visible in THIS photo (skin tone, texture, a specific visible trait) — no medical jargon, in ${languageName}>", "<a second, different concrete visible observation, in ${languageName}>", "<a third concrete visible observation, in ${languageName}>"],
...
"observed" is REQUIRED and must be exactly 3 short items, each one a concrete, specific, plain-language sentence about what you genuinely see in THIS photo — not a generic skincare truism, not a restatement of the quiz answers, and never a concern the user reported but that isn't actually visible. This is the very first thing shown to the user (even those who haven't paid), so it must feel immediately accurate and personal, like someone really looked at their face.
