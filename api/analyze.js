...
{
  "observed": "<a single flowing, well-developed paragraph (5-7 sentences, plain personal language, no medical jargon, no markdown, no bullet points, in ${languageName}) that EXPLICITLY connects the self-reported quiz answers (reported concerns and lifestyle habits) with what you genuinely see in THIS photo, states this with full confidence (you HAVE already looked at the photo — never say or imply that a photo analysis is still needed, that you 'would need to see' something, or any other hedge along those lines; you are looking at it right now), and explicitly names and DEVELOPS the probable cause(s) of what you see (e.g. lack of sleep, stress, sun exposure, diet, dehydration — pick from the reported habits when relevant, otherwise the most plausible general cause), explaining briefly HOW each cause produces the effect you're describing rather than just naming it. Confirm what matches (e.g. 'you mentioned X, and indeed the photo shows...'), and just as importantly, point out any mismatch — a concern the user reported that is NOT actually visible in the photo, or something visible that they didn't mention. Add a touch of visual specificity (where on the face, what it looks like — texture, tone, localized vs. diffuse) so it reads as a real, detailed observation rather than a short summary. This must read like someone who actually looked carefully at both the person's answers and their face and is telling them honestly and confidently what they found and why, with enough substance to feel thorough — never a generic skincare paragraph that could apply to anyone, never a two-line summary, and never a paragraph that hedges or defers to a future analysis.>",
